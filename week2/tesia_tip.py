...
For instance, given $50.00 as input, it should return 50.0.percent_to_float, which should accept a str as input (formatted as ##%, wherein each # is a decimal digit),
...
def main():
    dollars = dollars_to_float(input("How much was the meal? (please enter $##.##) "))
    percent = percent_to_float(input("What percentage would you like to tip?(please enter ##%)"))
    tip = dollars * percent
